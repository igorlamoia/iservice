...
export default function WorkerCard({ user = {}, botoesDesabilitados = false }) {
      ...
      >
        <header className="profile">
          ...
          <div className="profile-info">
            ...
            >
              <QueryBuilderIcon fontSize="small" /> {user.horaDe} -{' '}
              {user.horaAte}
            </Typography>
            <MyPopover
              title={
          ...
          <div className="review">
            {user.avaliacaoMaisRecente ? (
              ...
              <p>
                ...
                possui avaliações. Seja o primeiro a avaliar
              </p>
            )}
          </div>
          <Button
            ...
            onClick={handleSolicitacaoModal}
          >
            Solicitar Orçamento
          </Button>
        </Box>
      </Paper>
      <Solicitacao user={user} open={open} setOpen={setOpen} />
    </>
  );
}
