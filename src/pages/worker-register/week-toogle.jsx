...
export function ToogleWeekGroup() {
  ...
  return (
    ...
    >
      <MyToggleButton value="1" aria-label="bold" sx={{ px: 2 }}>
        <Tooltip title="Segunda-feira">
          <Typography>S</Typography>
        </Tooltip>
      </MyToggleButton>
      <MyToggleButton value="2" aria-label="bold" sx={{ px: 2 }}>
        <Tooltip title="Terça-feira">
          <Typography>T</Typography>
        </Tooltip>
      </MyToggleButton>
      <MyToggleButton value="3" aria-label="bold" sx={{ px: 2 }}>
        <Tooltip title="Quarta-feira">
          <Typography>Q</Typography>
        </Tooltip>
      </MyToggleButton>
      <MyToggleButton value="4" aria-label="bold" sx={{ px: 2 }}>
        <Tooltip title="Quinta-feira">
          <Typography>Q</Typography>
        </Tooltip>
      </MyToggleButton>
      <MyToggleButton value="5" aria-label="bold" sx={{ px: 2 }}>
        <Tooltip title="Sexta-feira">
          <Typography>S</Typography>
        </Tooltip>
      </MyToggleButton>
      <MyToggleButton value="6" aria-label="bold" sx={{ px: 2 }}>
        <Tooltip title="Sábado">
          <Typography>S</Typography>
        </Tooltip>
      </MyToggleButton>
      <MyToggleButton value="7" aria-label="bold" sx={{ px: 2 }}>
